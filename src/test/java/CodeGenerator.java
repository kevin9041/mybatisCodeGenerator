...
import com.tinckay.common.core.ProjectConstant;
...
public class CodeGenerator {
    ...
    private static final String JDBC_PASSWORD = "556600";
    ...
    private static final String AUTHOR = "Kevin";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
        genCode("sm_goods_batch");
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        //columnRenamingRule.setSearchString("^t_");
